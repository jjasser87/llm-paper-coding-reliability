...
# Load from parent directory (Coding Framework root)
...
# Configuration
BASE_DIR = Path(__file__).parent.parent  # Points to coding/ folder
PAPERS_DIR = BASE_DIR / "papers_for_coding"
RUN1_CSV = BASE_DIR / "run1" / "papers_coded_verified_fixed.csv"
OUTPUT_FILE = Path(__file__).parent / "papers_coded_gpt4o_2.csv"
