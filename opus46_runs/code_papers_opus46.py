#!/usr/bin/env python3
"""
Claude Opus 4.6 paper coding for inter-rater reliability.
Model: claude-opus-4-6 (released Feb 5, 2026)
Strict allowed values based on human-verified run1 data.
Usage: python code_papers_opus46.py <run_number>
...
def code_paper(paper_text, paper_title, arxiv_id):
    """Call Claude Opus 4.6 to code a paper."""
    content = None
    for attempt in range(RATE_LIMIT_MAX_RETRIES):
        try:
            message = client.messages.create(
                model="claude-opus-4-6",  # Latest Opus 4.6 (Feb 2026)
...
def main():
    print("=" * 70)
    print(f"CLAUDE OPUS 4.6 PAPER CODING - RUN {RUN_NUMBER}/3")
    print("=" * 70)
    ...
    print("=" * 70)
    print(f"\nEstimated cost per run: ~$12 (71 papers, Opus 4.6, increased text limit)")
