#!/usr/bin/env python3
"""
Run3: Claude Sonnet 4.5 paper coding for inter-rater reliability.
...
OUTPUT_FILE = Path(__file__).parent / "papers_coded_sonnet45.csv"
...
def main():
    print("=" * 70)
    print("RUN3: CLAUDE SONNET 4.5 PAPER CODING FOR INTER-RATER RELIABILITY")
    print("=" * 70)
    ...
    for i, paper in enumerate(papers):
        ...
        # Rate limiting - Anthropic has generous limits but be nice
        time.sleep(1.0)
    ...
    print("=" * 70)
    print(f"\nEstimated cost: ~$4 for 71 papers with Claude Sonnet 4.5")
